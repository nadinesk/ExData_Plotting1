...
lines(hpc.full_subset.dl$date_time, hpc.full_subset.dl$Sub_metering_1, lwd=1.5)
lines(hpc.full_subset.dl$date_time, hpc.full_subset.dl$Sub_metering_2, lwd=1.5, col="red")
lines(hpc.full_subset.dl$date_time, hpc.full_subset.dl$Sub_metering_3, lwd=1.5, col="blue")
